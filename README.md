...
| BBL Bank Contact-Center | Gathering information for Contact Center application LLD design, Co-ordinate with vendors and customer to implement UCCE contact center system, Agent Desktop, RightFax and Nice recording, Implemented Cisco UCCE ICM script for BBL contact center, Developed Cisco IVR and project requirements applications, Support and Troubleshooting Cisco Contact Center, Create and maintain program to support testing, security and implementation including SIP communication scripts, SIP communication message, UDP message, IVR and development environment, Communication with teams, customer, project sub-contract, developer to solved problem and support technical requirement by co-ordinates with customer IT department, Local policy and security policy, OS, web-engine, application and databases, Database and settings for application, create test cases, test scenarios and services. Service request, change request, document and knowledge support project. |
...
| Trade subaccout activities | Create backend and frontend communication by adaptive microservices architecture, trade stock online with Alpaca API market data. Develop the backend for AI robot trading and rule-based trading, store information for report and feedback to AI model trading results. |
...
<p align="center" width="100%">
    <img width="99.9%" src="https://github.com/jkaewprateep/Portfolio/blob/main/hackerranks_badges_20241119.png">  
</p>
...
* Understanding Data: Navigating Statistics, Science, and AI Specialization [MICHIGAN]( https://github.com/jkaewprateep/Portfolio/blob/main/Coursera%2057W8JLVY7ZRP.pdf )🔷
...
![Alt text](https://github.com/jkaewprateep/Portfolio/blob/main/Screenshot%202023-12-13%20170120.png?raw=true "Title")
...
![Alt text](https://github.com/jkaewprateep/Portfolio/blob/main/encoding.jpg?raw=true "Title")  <br />
