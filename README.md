...
| KTC Online Payment gateway API software, simulation and test | Update database and database scripts from Oracle 12c to Oracle 21c. | Update database and database scripts from Oracle 12c to Oracle 21c, Transforms application platform from Windows server to Redhat Linux 8 and 9 and Transform web engine from Tomcat to IBM WebSphere and related issues to compatibilities. |
